...
class HomeCategoryMovieAdapter(
    ...
    private var listMovieCategory: Map<Genre, MoviesByGenre>? = LinkedHashMap<Genre, MoviesByGenre>()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.rcvMovie.layoutManager = LinearLayoutManager(holder.itemView.context, LinearLayoutManager.HORIZONTAL, false)
